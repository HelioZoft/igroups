...
function() {
    var c, o, d, u, t, r, p, E, n, f, l, s, h, i, m, A, a, e, g, y = [].slice;
    ...
    o = /^\(?([^)]*)\)?(?:(.)(d+))?$/, c = 2e3, d = 2, u = 1e3 / 30, g = document.createElement("div").style, p = null != g.transition || null != g.webkitTransition || null != g.mozTransition || null != g.oTransition, h = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, t = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, n = function(t) {
        ...
        var e, i = this;
        return (e = (t = this.cleanValue(t)) - this.value) ? (s(this.el, "odometer-animating-up odometer-animating-down odometer-animating"), E(this.el, 0 < e ? "odometer-animating-up" : "odometer-animating-down"), this.stopWatchingMutations(), this.animate(t), this.startWatchingMutations(), setTimeout(function() {
            return i.el.offsetHeight, E(i.el, "odometer-animating")
        ...
        return o.innerHTML = t, i && E(o, i), this.insertDigit(o, e)
        ...
        var e, i, o, n, s, r, a, l, c, d, u, h, p, f, m, g, y, v, b, w, x, _, C, $, T, S = this.value,
            k = this.getFractionalDigitCount(S, t);
        if (k && (t *= Math.pow(10, k), S *= Math.pow(10, k)), o = t - S) {
            for (this.bindTransitionEnd(), n = this.getDigitCount(S, t), s = [], d = y = e = 0; 0 <= n ? y < n : n < y; d = 0 <= n ? ++y : --y) {
                ...
                for (d = v = 0, w = c.length; v < w; d = ++v) l = c[d], c[d] = Math.abs(l % 10);
                s.push(c)
            }
            for (this.resetDigits(), d = b = 0, x = ($ = s.reverse()).length; b < x; d = ++b)
                for (c = $[d], this.digits[d] || this.addDigit(" ", k <= d), null == (g = this.ribbons)[d] && (g[d] = this.digits[d].querySelector(".odometer-ribbon-inner")), this.ribbons[d].innerHTML = "", o < 0 && (c = c.reverse()), h = C = 0, _ = c.length; C < _; h = ++C) l = c[h], (f = document.createElement("div")).className = "odometer-value", f.innerHTML = l, this.ribbons[d].appendChild(f), h === c.length - 1 && E(f, "odometer-last-value"), 0 === h && E(f, "odometer-first-value");
            return m < 0 && this.addDigit("-"), null != (p = this.inside.querySelector(".odometer-radix-mark")) && p.parent.removeChild(p), k ? this.addSpacer(this.format.radix, this.digits[k - 1], "odometer-radix-mark") : void 0
        }
    ...
    function(t) {
        ...
        c.magnificPopup.registerModule(j, {
            ...
            proto: {
                initIframe: function() {
                    f.types.push(j), d("BeforeChange", function(t, e, i) {
                        e !== i && (e === j ? I() : i === j && I(!0))
                    }), d(l + "." + j, function() {
                        I()
                    })
        ...
        c.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    var s = f.st.gallery,
                        t = ".mfp-gallery";
                    return f.direction = !0, !(!s || !s.enabled) && (g += " mfp-gallery", d(b + t, function() {
                ...
                _preloadItem: function(t) {
                    var e;
                    t = L(t), f.items[t].preloaded || ((e = f.items[t]).parsed || (e = f.parseEl(t)), h("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0
        ...
        c.magnificPopup.registerModule(F, {
            ...
            proto: {
                initRetina: function() {
                    var i, o;
                    1 < window.devicePixelRatio && (i = f.st.retina, o = i.ratio, 1 < (o = isNaN(o) ? o() : o) && (d("ImageHasSize." + F, function(t, e) {
                        e.img.css({
    ...
    function() {
        ...
        function x(c, d, u) {
            var t, e, i, h, p;
            t = 0 < (t = d) ? 1 : -1, e = 0 < (e = u) ? 1 : -1, o.x === t && o.y === e || (o.x = t, o.y = e, v = [], w = 0), 1 != f.accelerationMax && ((e = Date.now() - w) < f.accelerationDelta && (1 < (i = (1 + 50 / e) / 2) && (i = Math.min(i, f.accelerationMax), d *= i, u *= i)), w = Date.now()), v.push({
                x: d,
                y: u,
                lastX: d < 0 ? .99 : -.99,
                lastY: u < 0 ? .99 : -.99,
                start: Date.now()
            }), b || (i = B(), h = c === i || c === document.body, null == c.$scrollBehavior && function(t) {
                var e = T(t);
                ...
                h ? window.scrollBy(i, o) : (i && (c.scrollLeft += i), o && (c.scrollTop += o)), d || u || (v = []), v.length ? V(p, c, 1e3 / f.frameRate + 1) : (b = !1, null != c.$scrollBehavior && (c.style.scrollBehavior = c.$scrollBehavior, c.$scrollBehavior = null))
            }, V(p, c, 0), b = !0)
        }
        ...
        function t(t) {
            ...
            p && (t.wheelDeltaX && F(t.wheelDeltaX, 120) && (i = t.wheelDeltaX / Math.abs(t.wheelDeltaX) * -120), t.wheelDeltaY && F(t.wheelDeltaY, 120) && (o = t.wheelDeltaY / Math.abs(t.wheelDeltaY) * -120)), i || o || (o = -t.wheelDelta || 0), 1 === t.deltaMode && (i *= 40, o *= 40);
            e = z(e);
            return e ? !! function(t) {
                if (!t) return;
                s.length || (s = [t, t, t]);
                ...
                var e = 120 < t && H(t),
                    e = !H(120) && !H(100) && !e;
                return t < 50 || e
            }(o) || (1.2 < Math.abs(i) && (i *= f.stepSize / 120), 1.2 < Math.abs(o) && (o *= f.stepSize / 120), x(e, i, o), t.preventDefault(), void A()) : !d || !G || (Object.defineProperty(t, "target", {
        ...
        function z(t) {
            ...
            do {
                ...
                if (e.push(t), o === t.scrollHeight) {
                    n = M(h) && M(i) || I(h);
                    if (d && O(h) || !d && n) return P(e, B())
                } else if (O(t) && I(t)) return P(e, t)
        ...
        var q, V = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(t, e, i) {
                window.setTimeout(t, i || 1e3 / 60)
            },
            W = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver,
            B = (q = document.scrollingElement, function() {
                var t, e;
                return q || ((t = document.createElement("div")).style.cssText = "height:10000px;width:1px;", document.body.appendChild(t), e = document.body.scrollTop, document.documentElement.scrollTop, window.scrollBy(0, 3), q = document.body.scrollTop != e ? document.body : document.documentElement, window.scrollBy(0, -3), document.body.removeChild(t)), q
            });
        ...
        var N = window.navigator.userAgent,
            ...
            Q = X && (/Version\/8/i.test(N) || /Version\/9/i.test(N)),
            Y = (G || X || Y) && !Z,
            U = !1;
        try {
        ...
        K && Y && (j(K, t, Z), j("mousedown", e), j("load", y)), J.destroy = function() {
            r && r.disconnect(), L(K, t), L("mousedown", e), L("keydown", _), L("resize", a), L("load", y)
                                ...
                                for (var y = o, v = n; y < e.length; v += e[y].length, ++y) {
                                    ...
                                    if (!(b instanceof P)) {
                                        if (f && y != e.length - 1) {
                                            ...
                                            for (var w = T.index + (p ? T[1].length : 0), x = T.index + T[0].length, _ = y, C = v, $ = e.length; _ < $ && (C < x || !e[_].type && !e[_ - 1].greedy); ++_)(C += e[_].length) <= w && (++y, v = C);
                                            if (e[y] instanceof P) continue;
                                            S = _ - y, b = t.slice(v, C), T.index -= v
                                        } else {
                                            u.lastIndex = 0;
                                            var T = u.exec(b),
                                                S = 1
                                        ...
                                        if (T) {
                                            p && (m = T[1] ? T[1].length : 0), x = (w = T.index + m) + (T = T[0].slice(m)).length;
                                            var k = b.slice(0, w),
                                                E = b.slice(x),
                                                b = [y, S];
